import math
from calculator.areas import areas as main
from calculator.advanced import geometry_extra as myfunctions
from calculator.arithmetic import arithmetic as mh
...
while True:
    ...
    if user=="exit":
        ...
        if x.lower()=="a":
            from calculator.menu import areas_menu
        elif x.lower()=="b":
            x=input("a-cylinder" "\nb-sphere""\nc-cubiod""\nd-cube""\ne-pyramid ""\nf-cone")
            if x.lower()=="a":
                myfunctions.VofCY()
